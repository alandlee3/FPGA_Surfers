...
set_max_delay -datapath_only 6 -from  [get_clocks clk_camera_cw_fast] -to [get_clocks clk_pixel_cw_hdmi]
set_max_delay -datapath_only 6 -from  [get_clocks clk_pixel_cw_hdmi] -to [get_clocks clk_camera_cw_fast]
